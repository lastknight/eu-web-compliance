...
- **ID stabili, per sempre.** L'ID di un controllo non viene mai riciclato o rinumerato. I controlli deprecati vengono marcati, non cancellati. Il tuo report di tre anni fa significa ancora qualcosa.
